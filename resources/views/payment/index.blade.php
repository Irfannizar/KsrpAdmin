                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item active">
                    ...
                    <div id="collapsePayment" class="collapse" aria-labelledby="paymentUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">select</h6>
                            <a class="collapse-item active" href="{{ route('payment.lists') }}">All Status</a>
                        </div>
                    </div>
                </li>
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <i class="fa fa-bars"></i>
                         ...
                         <!-- Topbar Search -->
                            <form method = "GET" action = "{{route('payment.search')}}" enctype="multipart/form-data" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
